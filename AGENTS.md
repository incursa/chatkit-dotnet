# chatkit-dotnet translation guidance

- This repository hosts the semantic .NET translation of the included ChatKit surface from https://github.com/openai/chatkit-js.
- Treat the upstream ChatKit JS repo as the source of truth for behavior; port only those behaviors that the upstream diff actually introduces.
